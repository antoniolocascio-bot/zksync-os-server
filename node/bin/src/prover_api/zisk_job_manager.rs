...
mod tests {
    ...
    async fn requeue_on_downstream_closed_keeps_prover_input() {
        ...
        drop(prove_receiver);
        let manager = ZiskJobManager::new(prove_sender, Duration::from_secs(60), None, TEST_CHAIN_ID, TEST_CHAIN_CONFIG);
    ...
    async fn vk_drift_rejects_submit_and_keeps_job_assigned() {
        ...
        let manager =
            ZiskJobManager::new(prove_sender, Duration::from_secs(60), Some(expected_vk), TEST_CHAIN_ID, TEST_CHAIN_CONFIG);
