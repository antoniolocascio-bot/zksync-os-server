...
/// prover-input blocking task; capping it bounds that cost (W1.3). An
...
/// prefix is found by a BOUNDED scan (see `push_code_from_blob` and W1.3).
...
mod tests {
    ...
    /// W1.3: when the recorded length carries alignment padding (too large),
